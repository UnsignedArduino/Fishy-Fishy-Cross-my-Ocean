...
function update_map () {
    ...
    minimap.includeSprite(map, player_fish, MinimapSpriteScale.MinimapScale)
    return minimap.getImage(map)
}
function create_map () {
    sprite_map = sprites.create(update_map(), SpriteKind.Map)
...
forever(function () {
    sprite_map.setImage(update_map())
})
